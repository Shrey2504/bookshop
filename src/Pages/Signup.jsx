...
export default function SignUp() {
  ...
  return (
    <section>
      <h1 className="text-6xl text-center mt-6 font-bold text-red-500">Sign Up</h1>
      <div className="flex justify-center flex-wrap items-center px-8 py-14 max-w-9xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <div className=" text-3xl flex justify-between whitespace-nowrap text-3sm sm:text-lg">
